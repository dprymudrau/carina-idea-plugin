...
public class GenerateGetTextActionHandlerImpl implements GenerateGetTextActionHandler, CodeInsightActionHandler {
    private static final Logger LOG = Logger.getInstance(GenerateGetTextActionHandlerImpl.class);
    ...
    private static void execAction(@NotNull final Project project, @NotNull final PsiClass clazz, final Editor editor){
        ...
        chooser.setTitle("generate getText()");
