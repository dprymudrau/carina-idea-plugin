...
public class GenerateClickActionHandlerImpl implements GenerateClickActionHandler, CodeInsightActionHandler {
    private static final Logger LOG = Logger.getInstance(GenerateClickActionHandlerImpl.class);
    ...
    private static void execAction(@NotNull final Project project, @NotNull final PsiClass clazz, final Editor editor){
        ...
        chooser.setTitle("generate click()");
